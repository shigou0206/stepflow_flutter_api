...
BaseState _$BaseStateFromJson(Map<String, dynamic> json) {
  return _BaseState.fromJson(json);
}
...
class _$BaseStateImpl implements _BaseState {
  ...
  factory _$BaseStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$BaseStateImplFromJson(json);
...
// ignore: invalid_annotation_target
  ...
  @override
  String toString() {
    return 'BaseState(comment: $comment, inputMapping: $inputMapping, outputMapping: $outputMapping, retry: $retry, catchPolicy: $catchPolicy, next: $next, end: $end)';
  }
...
abstract class _BaseState implements BaseState {
  const factory _BaseState(
      ...
      final List<CatchPolicy>? catchPolicy,
      final String? next,
      final bool? end}) = _$BaseStateImpl;

  factory _BaseState.fromJson(Map<String, dynamic> json) =
      _$BaseStateImpl.fromJson;
