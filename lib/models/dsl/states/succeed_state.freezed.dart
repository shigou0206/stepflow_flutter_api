...
// ignore: invalid_annotation_target
  ...
  @override
  String toString() {
    return 'SucceedState(comment: $comment, inputMapping: $inputMapping, outputMapping: $outputMapping, retry: $retry, catchPolicy: $catchPolicy, next: $next, end: $end)';
  }
...
abstract class _SucceedState extends SucceedState {
  const factory _SucceedState(
      ...
      final List<CatchPolicy>? catchPolicy,
      final String? next,
      final bool? end}) = _$SucceedStateImpl;
