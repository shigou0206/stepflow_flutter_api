...
ChoiceState _$ChoiceStateFromJson(Map<String, dynamic> json) {
  return _ChoiceState.fromJson(json);
}

/// @nodoc
mixin _$ChoiceState {
  List<ChoiceRule> get choices => throw _privateConstructorUsedError;
  String? get defaultNext => throw _privateConstructorUsedError;
  String? get comment =>
...
/// @nodoc
abstract class _$$ChoiceStateImplCopyWith<$Res>
    implements $ChoiceStateCopyWith<$Res> {
  factory _$$ChoiceStateImplCopyWith(
          _$ChoiceStateImpl value, $Res Function(_$ChoiceStateImpl) then) =
      __$$ChoiceStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<ChoiceRule> choices,
...
/// @nodoc
class __$$ChoiceStateImplCopyWithImpl<$Res>
    extends _$ChoiceStateCopyWithImpl<$Res, _$ChoiceStateImpl>
    implements _$$ChoiceStateImplCopyWith<$Res> {
  __$$ChoiceStateImplCopyWithImpl(
      _$ChoiceStateImpl _value, $Res Function(_$ChoiceStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ChoiceStateImpl(
      choices: null == choices
          ? _value._choices
          : choices // ignore: cast_nullable_to_non_nullable
              as List<ChoiceRule>,
...
/// @nodoc
@JsonSerializable()
class _$ChoiceStateImpl extends _ChoiceState {
  const _$ChoiceStateImpl(
      {required final List<ChoiceRule> choices,
      this.defaultNext,
      this.comment = null,
  ...
  factory _$ChoiceStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$ChoiceStateImplFromJson(json);

  final List<ChoiceRule> _choices;
  @override
  List<ChoiceRule> get choices {
...
// ignore: invalid_annotation_target
  ...
  @override
  String toString() {
    return 'ChoiceState(choices: $choices, defaultNext: $defaultNext, comment: $comment, inputMapping: $inputMapping, outputMapping: $outputMapping, retry: $retry, catchPolicy: $catchPolicy, next: $next, end: $end)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ChoiceStateImplCopyWith<_$ChoiceStateImpl> get copyWith =>
      __$$ChoiceStateImplCopyWithImpl<_$ChoiceStateImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ChoiceStateImplToJson(
      this,
    );
  }
}

abstract class _ChoiceState extends ChoiceState {
  const factory _ChoiceState(
      ...
      final List<CatchPolicy>? catchPolicy,
      final String? next,
      final bool? end}) = _$ChoiceStateImpl;
  const _ChoiceState._() : super._();

  factory _ChoiceState.fromJson(Map<String, dynamic> json) =
      _$ChoiceStateImpl.fromJson;

  @override
  List<ChoiceRule> get choices;
  @override
  String? get defaultNext;
  @override
  String? get comment;
